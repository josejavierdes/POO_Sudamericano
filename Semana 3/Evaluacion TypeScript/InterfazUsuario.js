...
// InterfazUsuarioModule.ts
const readline = __importStar(require("readline"));
// Creamos una interfaz para el lector de la consola
...
function capturarEntradaUsuario() {
    return new Promise((resolve) => {
        rl.question('> ', (answer) => {
            resolve(answer.trim()); // Eliminamos espacios en blanco alrededor de la entrada del usuario
        });
    });
}
